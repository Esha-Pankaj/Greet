package com.advjava.bugtracker.dao;
...
import net.javaguides.Bugapp.dao.BugDao;
...
public class BugDaoImpl implements BugDao {
	...
	public void insertTodo(Todo todo) throws SQLException {
		...
		try (Connection connection = JDBCUtils.getConnection();
			...
			preparedStatement.setString(3, todo.getuserassign());
	...
	public Todo selectTodo(long todoId) {
		...
		try (Connection connection = JDBCUtils.getConnection();
			...
			while (rs.next()) {
				...
				String userassign = rs.getString("description");
				LocalDate targetDate = rs.getDate("target_date").toLocalDate();
				String isDone = rs.getString("is_done");
				todo = new Todo(id, title, username, userassign, targetDate, isDone);
			}
		} catch (SQLException exception) {
	...
	public boolean updateTodo(Todo todo) throws SQLException {
		...
		try (Connection connection = JDBCUtils.getConnection();
			...
			statement.setString(3, todo.getuserassign());
